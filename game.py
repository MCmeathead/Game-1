...
def normalise_input(user_input):
    ...
    #Remove leadinjg and trailing spaces from a string
...
def print_menu(exits):
    ...
    for b in exits:
        print_menu_line(b, exit_leads_to(exits,b))
...
def menu(exits):
    ...
    while True:
        ...
        user_input = input("> ")
        # Normalise the input
        normal_input = normalise_input(user_input)
        if is_valid_exit(exits,normal_input) == True:
            return normal_input
